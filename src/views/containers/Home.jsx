                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-sm-12 col-md-3 text-center">
                            <div className="bg-light rounded-circle mx-auto p-2 d-flex" style={{ width: 130, height: 130 }}>
                                <svg className="bi bi-card-heading text-dark mx-auto my-auto" width="5em" height="5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="mt-3 lead-title">Seguro Todo Riesgo</h2>
                            <p>
                        ...
                        <div className="col-sm-12 col-md-4 text-center">
                            <div className="bg-light rounded-circle mx-auto p-2 d-flex" style={{ width: 130, height: 130 }}>
                                <svg className="bi bi-person-check text-dark mx-auto my-auto" width="5em" height="5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="mt-3 lead-title">Totalmente Seguro</h2>
                            <p>
                        ...
                        <div className="col-sm-12 col-md-4 text-center">
                            <div className="bg-light rounded-circle mx-auto p-2 d-flex" style={{ width: 130, height: 130 }}>
                                <svg className="bi bi-hand-thumbs-up text-dark mx-auto my-auto" width="5em" height="5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="mt-3 lead-title">FÁCIL Y RÁPIDO</h2>
                            <p>
